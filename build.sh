...
TEMP_DIR='/tmp/NetiPurchaseHistory/Frontend/NetiPurchaseHistory'
CURRENT_DIR=$(pwd)
...
zip -qr "${CURRENT_DIR}/NetiPurchaseHistory-${VERSION}.zip" $(basename $(dirname $TEMP_DIR))
cd $CURRENT_DIR
echo "Package wurde erstellt unter ${CURRENT_DIR}/NetiPurchaseHistory-${VERSION}.zip"
